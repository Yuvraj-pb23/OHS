...
class TextChatbot:
    ...
    def predict_answer(self, user_question, suggestion_threshold=0.60):
        ...
        if top_score >= suggestion_threshold:
            ...
            return (
                f"We regret that your query falls outside RoadAthena scope; Our AI chatbot is continually improving to broaden its capabilities, Did you mean one of these?\n\n{options}\n\n"
            )
